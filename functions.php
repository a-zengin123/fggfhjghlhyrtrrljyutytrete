...
/* Breadcrumb Begin */
 function sayara_automotive_the_breadcrumb() {
 	if (!is_home()) {
 		echo '<a href="';
...
function sayara_automotive_setup() {
	...
	load_theme_textdomain( 'sayara-automotive', get_template_directory() . '/languages' );
...
function sayara_automotive_scripts() {
    ...
    // Body
    $sayara_automotive_body_color = get_theme_mod('sayara_automotive_body_color', '');
    $sayara_automotive_body_font_family = get_theme_mod('sayara_automotive_body_font_family', '');
    $sayara_automotive_body_font_size = get_theme_mod('sayara_automotive_body_font_size', '');
	// Paragraph
	...
	$sayara_automotive_custom_css ='
	    body{
		    color:'.esc_html($sayara_automotive_body_color).'!important;
		    font-family: '.esc_html($sayara_automotive_body_font_family).'!important;
		    font-size: '.esc_html($sayara_automotive_body_font_size).'px !important;
		}
		p,span{
